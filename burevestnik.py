...
class AirSpaceMonitor(ctk.CTk):
    ...
    def _build_layout(self):
        ...
        self.camera_button.grid(row=3, column=0, padx=24, pady=(0,12), sticky="ew")
        ...
        self.camera_list.grid(row=9, column=0, padx=24, pady=(0,12), sticky="nsew")
        ...
        self.video_frame.grid(row=1, column=0, sticky="nsew", padx=26, pady=(8,8))
        ...
        table_frame.grid(row=2, column=0, sticky="ew", padx=26, pady=(0,8))
        ...
        for tid, tr in tracks_dict.items():
            ...
            if self.roi:
                ...
                if rx1<cx<rx2 and ry1<cy<ry2:
                    ...
                    if tid not in self.alarmed_track_ids:
                        self.alarmed_track_ids.add(tid)
                        self._play_alarm_sound()

        self.alarmed_track_ids &= current_zone_ids
    ...
    def _play_alarm_sound(self):
        now = time.monotonic()
        if now - self.last_alarm_sound_at < 2.0:
            return
